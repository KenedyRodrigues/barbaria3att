...
export default function SalvarHorario({ navigation }) {
  ...
  const agendar = async () => {
    console.log('Função agendar chamada'); // Adicionando log para verificar se a função foi chamada
    ...
    try {
      const response = await axios.post('http://192.168.15.143:5001/api/agendar', {
        nome: nomeCer,
